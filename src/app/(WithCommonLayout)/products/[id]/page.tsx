...
import { CircleCheckBig, Heart, MapPin, RefreshCw, ShoppingCart } from "lucide-react";
...
export default async function ProductDetails({
    ...
    return (
        <div className="w-[90%] mx-auto">
            <h2 className="text-[28px] text-[#181D25] font-semibold my-6">Apple iPhone 14 Plus 128GB Blue</h2>
            ...
            <div className="grid md:grid-cols-2 gap-24">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-8 my-3">
                        ...
                        <p className="text-xs text-[#181D25] border border-[#181D25] rounded-[8px] py-2 px-4 font-normal">128 GB</p>
                    </div>
                    ...
                    <div className="flex justify-between items-center gap-3 mt-6 mb-4">
                        ...
                        <p className="text-xs text-[#33B36B] font-normal flex gap-2 items-center"><CircleCheckBig className="w-[14px]" /> Available to order </p>
                    </div>
                    ...
                    <div className="mt-14">
                        <div className="flex justify-between items-center gap-3 mt-6 mb-4">
                            <h3 className="text-2xl text-[#181D25] font-semibold">Location:</h3>
                            <p className="flex gap-2 py-3 px-4 items-center bg-[#EEF1F6] rounded-[8px] text-[#333D4C] text-sm font-medium"><MapPin /> Location</p>
                        </div>
                    </div>
