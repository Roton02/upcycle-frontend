...
const banners = [
  {
    id: 1,
    title: "NEW FALL SEASON 2024",
    subtitle: "The new warm collection",
    image: image,
  ...
  },
  {
    ...
    subtitle: "Cozy styles for cold days",
    image: image,
  ...
  },
  {
    ...
    subtitle: "Festive looks for every occasion",
    image: image,
          ...
          {banners.map((banner, index) => (
            <div key={banner.id} className="flex-[0_0_100%] min-w-0">
              <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between md:h-[600px] lg:h-[650px]">
                  {/* Text Content */}
