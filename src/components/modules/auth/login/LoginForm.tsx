                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="w-full max-w-[400px]">
                        <div>
                            ...
                            <p className="text-sm font-normal text-[#4E5562] mt-4 mb-6">Do not have an account?<Link href={'/register'} className="text-sm text-[#181D25] font-medium cursor-pointer underline ml-2">Create an account</Link></p>
                        </div>
